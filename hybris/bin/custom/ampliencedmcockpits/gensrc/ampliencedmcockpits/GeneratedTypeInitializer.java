...
public class GeneratedTypeInitializer extends AbstractTypeInitializer
{
	...
	protected final void performModifyTypes( final ManagerEJB manager, Map params ) throws JaloBusinessException
	{
		// performModifyTypes
				...
				single_createattr_Product_amplienceThumbnailUrl();
			

	}

	
	public void single_createattr_Product_amplienceThumbnailUrl() throws JaloBusinessException
	{
		
				createDynamicAttribute(
					"Product", 
					"amplienceThumbnailUrl",  
					"java.lang.String",
					null,
	...
	protected final void performCreateObjects( final ManagerEJB manager, Map params ) throws JaloBusinessException
	{
		// performCreateObjects
			...
			single_setAttributeProperties_Product_amplienceThumbnailUrl();
		
	}


		
						public void single_setAttributeProperties_Product_amplienceThumbnailUrl() throws JaloBusinessException
						{
							...
							setAttributeProperties(
								...
								null,
								customPropsMap,
								"amplienceThumbnailUrlAttributeHandler"
							);
						}
