...
public class AmplienceProductImageStatusUpdateJobPerformableTest
{
	...
	private AmplienceProductImageStatusUpdateCronJobModel cronJobModel = new AmplienceProductImageStatusUpdateCronJobModel()
	{{
		setCode("cronjob-code-123");
		setLongQuery("cronjob-query-123");
	}};
	...
	{
		final Map<String, Object> expectedResult = new HashMap<String, Object>()
		{{
