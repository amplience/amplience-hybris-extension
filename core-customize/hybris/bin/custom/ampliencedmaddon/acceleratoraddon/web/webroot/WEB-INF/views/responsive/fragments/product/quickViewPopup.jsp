...
<div class="quick-view-popup">
	...
	<div class="product-image">
		<amplience:viewerKitProductGallery product="${product}" quickView="true"/>
	</div>
	<div class="product-details">
		...
		<%-- Break after rendering review stars. --%><div>&nbsp;</div>

		<div class="summary">${ycommerce:sanitizeHTML(product.summary)}</div>

		<%-- Padding after the summary. --%><div style="opacity: 0">padding padding padding padding padding padding padding padding padding padding padding padding padding</div>
